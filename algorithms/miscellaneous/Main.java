...
// // var array = new Integer[] { -1, -22, 8, 128, 201, -123, 2, 9090, 2, -1190,
// 0
// // };
...
// var list1 = asList(new Integer[] { 101, 5, 9, 31, 33, 10, 100, 4, 8, 32, 500,
// 11, 99, 34 });
...
// public static <T extends Comparable<T>> Boolean hasDuplicates(List<T> list,
...
// public static <T extends Comparable<T>> Boolean merge(List<T> list, Integer
// start, Integer middle, Integer end) {
...
// public static <T extends Comparable<T>> Integer countRange(List<T> list, T
...
// public static <T extends Comparable<? super T>> void mergeSort(Node<T> list,
// Integer size) {
// if (size == 2) {
